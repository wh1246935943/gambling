    ...
    $(function(){
        ...
        layui.use('form',function(){
            ...
            form.on('submit(login)', function(data){
                ...
                $.fn.jcb.post('<?php echo url("login/login"); ?>',data.field,false,callbackfunc);
                return false;
            });
        });
    });
