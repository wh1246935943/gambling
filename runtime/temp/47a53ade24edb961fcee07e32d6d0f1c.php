<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/1.agrrdz.top/public/../application/index/view/user/bets.html";i:1711617368;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
              ...
              if (data) {
                ...
                for (
                  ...
                  if (i == Math.min(pageNum, data_array.length) - 1) {
                    li =
                      li +
                      `<div class='page'><span>当前页输赢:<span>${nowTotal}</span></span><div><button class='last'>上一页</button><button class='next'>下一页</button>${nowPage}/${totalPage}</div></div>`;
                  }
                }
                if (li != "") {
                  $("#betlog").append(li);
