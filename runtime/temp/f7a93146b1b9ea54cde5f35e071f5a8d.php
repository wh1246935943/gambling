<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/1.agrrdz.top/public/../application/index/view/index/register.html";i:1711356058;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="column b-35">
              <div class="form-table layui-form">
                <div class="form-row input">
                  <div
                    class="tp-ui-item tp-ui-forminput tp-ui-text tp-ui-text-base"
                  >
                ...
                <div class="code">
                  ...
                  <div style="width: 2.24rem; height: 0.8rem">
                    <a
                      class="image captcha"
                      name="valcodebtn"
                      style="height: 100%; width: 100%; margin-left: 0.23rem"
                    >
                      <img
                ...
                <p
                  ...
                  style="margin-bottom: 20px; color: #ffffff;display: flex;
                  align-items: center;"
                >
                  <input type="checkbox" name="agree" checked /><span
                ...
                <!-- <div class="form-row goregister">
                                <a href="<?php echo url('index/index/login2'); ?>">点击登录</a>
                            </div> -->
                <div class="form-row">
                  <div class="login_btn">
