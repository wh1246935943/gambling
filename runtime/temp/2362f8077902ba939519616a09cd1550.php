<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/1.agrrdz.top/public/../application/index/view/index/login.html";i:1722967426;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
      ...
      <div class="login">
        ...
        <div>
          ...
          <div class="goregister">
            <a href="<?php echo url('index/register'); ?>">点击注册</a>
          </div>
        </div>
      </div>
    </div>
