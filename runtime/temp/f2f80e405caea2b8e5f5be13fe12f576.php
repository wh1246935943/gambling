<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\development\outwork-gambling\public/../application/index\view\game\index.html";i:1723094679;s:83:"D:\development\outwork-gambling\public/../application/index\view\public\footer.html";i:1723185393;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title data-translate="game_title">首页</title>
...
<body style="height: 100vh">
  <div id="tips">
    <p class="title" data-translate="game_tips_title">提示</p>
    <p class="content" data-translate="game_tips_content">请联系客服开通代理权限</p>
    <button class="enterbtn" onclick="closeTips()" data-translate="game_tips_button">确定</button>
  </div>
  <div class="toast" id="toastMessage">
    <img src="/static/images/duihao.png" alt="" />
    <div style="font-size: .3rem;" data-translate="game_toast_message">复制成功</div>
  </div>
  <div id="share">
    ...
    <div class="share-200">
      <div class="share-100">
        <div class="share-in" id="wx">
          <img src="/static/images/share.png" alt="" style="width: 288px; height: 315px" />
          <div class="zi" data-translate="game_wx_qrcode">微信推广二维码</div>
      ...
      <div class="share-100">
        <div class="share-in" id="web">
          <img src="/static/images/share.png" alt="" style="width: 288px; height: 315px" />
          <div class="zi" data-translate="game_web_qrcode">网页推广二维码</div>
    ...
    <div class="share-bottom">
      <div class="btn" onclick="save()">
        ...
        <p data-translate="game_save_image">保存图片</p>
      </div>
      <div class="btn" onclick="copyUrl()">
        <img src="/static/images/sharelink.png" alt="" />
        <p data-translate="game_copy_link">复制链接</p>
      </div>
    </div>
  </div>
  ...
  <div id="notic">
    <div class="notic-title">
      <span data-translate="game_notice_title">公告</span>
      <span onclick="closeNotic()" style="color: #fff; font-size: 36px">×</span>
    </div>
  ...
  <div class="toptitle">
    ...
    <div class="topright">
      ...
      <a href="/index/user/recharge.php" title="" class="deault5" data-translate="game_recharge">充值</a>
    </div>
  </div>
  <div id="app">
    <div class="topCon">
          ...
          <div class="scroll-tip iconfont icon-laba">
            <div class="list_lh" style="line-height: 14px">
              <ul class="move" style="margin-left: 0.2rem;">
                ...
                <li class="clearfix">
                  <p style="font-size: 18px" data-translate="game_congrats">恭喜：<?php echo $moneygo['username']; ?>成功提现<?php echo $moneygo['tx_money']; ?>元</p>
                </li>
      ...
      <div class="money" style="padding: 10px">
        <img src="<?php echo (isset($usermore['headimgurl']) && ($usermore['headimgurl'] !== '')?$usermore['headimgurl']:'/static/images/default.png'); ?>" alt="" style="width: 51px;height: 51px;border-radius: 50%;border: 2px solid #fff;" />
        <a href="<?php echo url('user/yongjin'); ?>" class="money-a">
          <img src="/static/images/shouru.png" alt="" />
          <div data-translate="game_my_commission">我的佣金</div>
        </a>
        <a href="/index/user/bets.php" class="money-a">
          <img src="/static/images/touzhu.png" alt="" />
          <div data-translate="game_bet_records">投注记录</div>
        </a>
        <a href="<?php echo url('user/tx'); ?>" class="money-a">
          <img src="/static/images/tixianhome.png" alt="" />
          <div data-translate="game_withdraw">提现</div>
        </a>
        <a onclick="toTuiguang()" class="money-a">
          <img src="/static/images/yaoqinghaoyoujin.png" alt="" />
          <div data-translate="game_invite_friends">邀请好友</div>
        </a>
      </div>
      <div class="ye-quan ye-2">
        <ul class="type">
          ...
          <li class="you-xi <?php echo $v['type']; ?>" onclick="changGame('<?php echo $v['type']; ?>')">
            <div class="guizhe" onclick="hideGuizhe()">
              <div class="bg" onclick="stopPropagation(event)">
                <h2 data-translate="game_introduction_title">[游戏介绍]</h2>
                <p><?php echo $v['game_js']; ?></p>
                <h2 data-translate="game_related_info_title">[相关资料]</h2>
                <p><?php echo $v['game_zl']; ?></p>
                <h2 data-translate="game_play_title">[玩法]</h2>
                <p><?php echo $v['game_js']; ?></p>
              </div>
            </div>
          </li>
            ...
            <li class="room-01">
              <div class="txt1">
                ...
                <a
                  ...
                  data-translate="game_enter_immediately"
                  >立即进入</a
                >
              </div>
            </li>
...
<script>
    ...
    function save() {
      ...
      var name = dom === "wx" ? i18next.getTranslation('game_wx_qrcode') : i18next.getTranslation('game_web_qrcode');
