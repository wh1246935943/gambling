    ...
    function login(){
        ...
        if (strpos($user_agent, 'MicroMessenger') === FALSE) {
            if(in_array(2, $login)){
                ...
                $url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxecbcf19fb27bb055&redirect_uri='.urlencode($call).'&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
                header("Location:".$url);
                die();
            }
        }else{
