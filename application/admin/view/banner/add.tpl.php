        ...
        <div class="layui-tab-item layui-show">
           <div style="margin-bottom: 10px">
                <ul class="layui-tab-title main-tab-title" style="display: flex;justify-content: space-between;padding-right: 0;padding-left: 0">
                    <li>
                        <div class="main-tab-item">添加广告</div>
                    </li>
                </ul>
            </div>
            <form class="layui-form" action="" method="post" enctype="multipart/form-data" style="width: 95%">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" required lay-verify="title" placeholder="请输入名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item aa" style="margin-bottom: 50px;">
                    ...
                    <div class="site-demo-upload">
                        <img id="avatar_img" src="" style="width: 150px;height: 150px;">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block" style="width: 74.4%">
                        <input type="radio" name="is_go" lay-filter="is_go" value="0" title="否" checked>
                        <input type="radio" name="is_go" lay-filter="is_go" value="1" title="是" >
                    </div>
                </div>

                <div class="layui-form-item" id="tzadd" style="display: none">
                    <label class="layui-form-label">跳转地址</label>
                    <div class="layui-input-block">
                        <input type="text" name="url" required  placeholder="请输入跳转地址" value="http://" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="number" name="order_index"  required  placeholder="值越大排越后面" autocomplete="off" class="layui-input">
                    </div>
                </div>
...
<script>
    ...
    layui.use(['form', 'upload','laydate'], function () {
        ...
        form.on('submit(fsubmit)', function(data){
            parent.$.fn.jcb.post('{:url("banner/add")}',data.field,false,backindex);
            return false;
        });
