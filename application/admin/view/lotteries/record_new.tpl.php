                ...
                <table class="table table-border table-bordered table-bg table-hover list-table">
                    <thead>
                        <tr class="text-c" style="background: #e7e7e7;">
                            ...
                            <th style="font-size:24px;">生肖</th>
                            <th style="font-size:24px;">特肖</th>
                            <th style="font-size:24px;">特（大/小）</th>
                            <th style="font-size:24px;">特（单/双）</th>
                        ...
                        {volist name="members" id="vo"}
                            <tr class="text-c">
                                ...
                                <td>
                                    ...
                                    $k=count($tmp_arr);
                                    for($i=0;$i<$k;$i++){
                                        echo "<span class='pk_28 sum'>".$shengxiao_array[$tmp_arr[$i]%12].",</span>";
                                    }
                                    ?>
                                </td>
                                <td>
                                    ...
                                    $tmp_arr = explode('-',$vo['outcome']);
                                    $k=count($tmp_arr);
                                    echo "<span class='pk_28 sum'>" . $shengxiao_array[$tmp_arr[6] % 12] . ",</span>";
                                    ?>
                                </td>
                                <td style="font-size:20px;">
                                    ...
                                    $k=count($tmp_arr);
                                    if($tmp_arr[6]>=25){
                                        echo '<span class="bg_blue pk_28">小</span>';
                                    }else{
                                        echo '<span class="bg_red pk_28">大</span>';
                                    }
                                    ?>
                                </td>
                                <td style="font-size:20px;">
                                    ...
                                    $k=count($tmp_arr);
                                    if($tmp_arr[6]%2==0){
                                        echo '<span class="bg_blue pk_28">双</span>';
                                    }else{
                                        echo '<span class="bg_red pk_28">单</span>';
                                    }
                                    ?>
                                </td>
