    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            ...
            <form class="layui-form layui-form-pane search-form">
                <a class="layui-btn" href="{:url('/admin/menu/add')}" style="width: 120px"><i class="layui-icon">&#xe608;</i>添加菜单</a>
                <!-- 每页数据量 -->
                ...
                <table class="list-table">
                    ...
                    {volist name="substation" id="v"}
                        <tr>
                            ...
                            {if $v['parent_name']!=null}
                            <td style="text-align: center">{$v['parent_name']}</td>
                            {else}
                            <td style="text-align: center">一级菜单</td>
                            {/if}
                            <td style="text-align: center">{$v['icon']}</td>
                            <td style="text-align: center">{$v['index']}</td>
                            ...
                            <td style="text-align: center">
                                <a href="{:url('/admin/menu/edit',array('id'=>$v['id']))}" class="layui-btn layui-btn-small" title="编辑"><i class="layui-icon"></i></a>
...
<script type="text/javascript">
    ...
    layui.use(['element', 'laypage', 'layer', 'form'], function () {
        ...
        form.on('switch(switchTest)', function (data) {
            ...
            parent.$.fn.jcb.post('/admin/menu/check',{'id': id, 'check': this.checked},false);
        ...
        form.on('submit(delete)', function (data) {
            ...
            parent.$.fn.jcb.confirm(true,'确定批量删除?','{:url("/admin/menu/batches_delete",array("video"=>$video))}',reload,data.field);
            return false;
        });
