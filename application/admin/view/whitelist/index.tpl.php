    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            ...
            <form class="layui-form layui-form-pane search-form">
                <a class="layui-btn" href="{:url('/admin/whitelist/add')}" style="width: 120px"><i class="layui-icon">&#xe608;</i>添加白名单</a>
                <!-- 每页数据量 -->
                ...
                <table class="list-table">
                    ...
                    {volist name="substation" id="v"}                     
                        <tr>
                            ...
                            <td style="text-align: center">
                                <a href="{:url('/admin/whitelist/edit',array('id'=>$v['id']))}" class="layui-btn layui-btn-small" title="编辑"><i class="layui-icon"></i></a>
                                ...
                                <a class="layui-btn layui-btn-small layui-btn-danger"
                                   ...
                                   data-del
                                   data-func='reload'
                                   data-src='{:url("/admin/whitelist/del")}'
...
<script type="text/javascript">
    ...
    layui.use(['element', 'laypage', 'layer', 'form'], function () {
        ...
        form.on('switch(switchTest)', function (data) {
            ...
            parent.$.fn.jcb.post('/admin/whitelist/check',{'id': id, 'check': this.checked},false);
        ...
        form.on('submit(delete)', function (data) {
            ...
            parent.$.fn.jcb.confirm(true,'确定批量删除?','{:url("/admin/whitelist/batches_delete",array("video"=>$video))}',reload,data.field);
            return false;
        }); 
