    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            ...
            <form class="layui-form layui-form-pane search-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="xuanzhe_time" value="{$xuanzhe_time}" id="start" placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})">
                    </div>
            ...
            <form class="layui-form">
                <div style="text-align: center;"> ( {$start_time|date="Y-m-d H:i",###} ~ {$end_time|date="Y-m-d H:i",###} ) </div>
