                    ...
                    {volist name='members' id='v'}
                        <tr>
                            ...
                            <td style="text-align: center">
                                {if !$v['outcome']}<span>未开奖</span>{elseif ($v['money']+$v['zj_money']) < 0}<span style="background: #777;padding: 0.3rem;color: #fff;border-radius: 0.25rem;">亏</span>{elseif ($v['money']+$v['zj_money']) > 0}<span style="background: #5cb85c;padding: 0.3rem;color: #fff;border-radius: 0.25rem;">赢</span>{/if}
                            </td>
