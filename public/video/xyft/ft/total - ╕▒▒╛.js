...
var firstTopDisLayer = cc.Layer.extend({
	...
	pk10 = cc.Layer.extend({
		...
		init: function() {
			...
			$.getJSON(g_hostIp, function(b) {
				b.next.delayTimeInterval=0;
				a._topLayer._qishuLable.setString(b.current.qihao);
				a._topLayer._nextQishuLable.setString(b.next.qihao);
				...
				a._btmLayer._curQihao.setString(b.current.qihao, cc.p(-174, -25), 24);
				a._curPed = b.current.qihao;
				a._nextPed = b.next.qihao;
		...
		loadDataFromServer: function(a) {
			...
			$.getJSON(g_hostIp, function(a) {
				if (b._nextPed == a.current.qihao) {
					...
					b._topLayer._qishuLable.setString(a.current.qihao);
					b._topLayer._nextQishuLable.setString(a.next.qihao);
					...
					b._btmLayer._curQihao.setString(a.current.qihao, cc.p(-174, -25), 24);
	...
	result = cc.Layer.extend({
		...
		initByParas: function(a, b) {
			...
			this.topLayer._qishuLable.setString(a.qihao);
			this.topLayer._nextQishuLable.setString(b.qihao);
			...
			this.btmLayer._curQihao.setString(a.qihao, cc.p(-174, -25), 24)
		},
		init: function() {
			var a = this;
	...
	MidActionLayer = cc.Layer.extend({
		...
		initCarSprite: function(a) {
			...
			b = cc.Sprite.create("http://rescsj.56hx.com/mobile/pk10video/res/rank3.png");
			...
			b = cc.Sprite.create("http://rescsj.56hx.com/mobile/pk10video/res/rank2.png");
			b.setPosition(cc.p(120, 350));
			...
			a = cc.Sprite.create("http://rescsj.56hx.com/mobile/pk10video/res/rank1.png");
