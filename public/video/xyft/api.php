...
$IntervalTimeMs=strtotime($json['data'][4]['next_time'])."000";
$IntervalTimeMs = $IntervalTimeMs - getTimestamp(13);
$periodNumber1 = $json['data'][4]['open_phase'];
$periodNumber2 = $json['data'][4]['next_phase'];
echo "
{
	...
	\"current\":{
		...
		\"qihao\":" . $periodNumber1 . ",
		\"awardTime\":\"" . $json['data'][4]['open_time'] . "\",
		\"awardNumbers\":\"". $opencode ."\"
	},\"next\":{
		\"periodNumber\":".$periodNumber2.",
		\"qihao\":".$periodNumber2.",
		\"awardTime\":\"". $json['data'][4]['next_time'] ."\",
