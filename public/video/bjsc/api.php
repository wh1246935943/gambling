...
$IntervalTimeMs=strtotime($json['data'][3]['next_time'])."000";
$IntervalTimeMs = $IntervalTimeMs - getTimestamp(13);
$periodNumber1 = (int)$json['data'][3]['open_phase'];
$periodNumber2 = (int)$json['data'][3]['next_phase'];
echo "
{
	\"time\":".getTimestamp(13).",
	\"current\":{
		\"periodNumber\":" . $periodNumber1 . ",
		\"awardTime\":\"" . $json['data'][3]['open_time'] . "\",
		\"awardNumbers\":\"". $opencode ."\"
	},\"next\":{
		\"periodNumber\":".$periodNumber2.",
		\"awardTime\":\"". $json['data'][3]['next_time'] ."\",
