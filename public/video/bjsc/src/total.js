...
var firstTopDisLayer = cc.Layer.extend({
    ...
    CarManagerLayer = cc.Layer.extend({
        ...
        init: function () {
            ...
            for (var b = 0; b < maxCarNumber; b++)
                for (var c = Number(a[b]), d = !1; !d;)
                    for (var e = 0; e < maxCarNumber; e++)
                        if (this._carArray[e].getCarIndex() == c) {
        ...
        init: function () {
            ...
            if (b)
                for (var c = 0; c < a.length; ++c) {
                    ...
                    for (c = 0; 10 > c; c++) d = cc.Sprite.create(numberIndexSrc[c]), d.setPosition(cc.p(65 * c + 170, 595)), this.addChild(d, 4), this._carNumberSpr[c] = d
            ...
            for (var b = a = 0, c = 0; c < maxCarNumber - 1; c++) {
                ...
                for (var d = c + 1; d < maxCarNumber; d++)
                    if (this._carMgrLayer._carArray[d]._carSpr.getPosition().x < a) {
    ...
    MidActionLayer = cc.Layer.extend({
        ...
        init: function () {
            ...
            this.carRankOne.setPosition(cc.p(390, -100));
            ...
            this.carRankTwo.setPosition(cc.p(-290, -120));
            ...
            this.carRankThree.setPosition(cc.p(70, -120));
...
var ParticleDemo = cc.LayerGradient.extend({
        _emitter: null,
        _background: null,
        setColor: function () {}, ctor: function () {
            this._super();
