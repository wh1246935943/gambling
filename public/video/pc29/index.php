...
if(!empty($_SESSION['video_time'])){
    ...
    $date = time();
    $start_time = strtotime(date('Y-m-d '.$video_time['pc28']['start_time']));
    $end_time   = strtotime(date('Y-m-d '.$video_time['pc28']['end_time']));
...
<body>
    ...
    <div class="info-wrapper">
        <div class="stage-info">
            <div class="img-wrapper"><img src="images/pc28.png"></div> 
            <div class="stage">
